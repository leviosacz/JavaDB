 ...
 * ValidCheck
 * When the database starts, random bytes are filled in bytes 100~107,
 * and when the database is closed, they are copied to bytes 108~115.
 * Used to determine whether the database was shut down normally last time
 */
